        ...
        <div className="home-navbar">
          <div className="home-left-side">
            ...
            <div className="home-links-container1">
              ...
              <a href="#ourstory" className="home-link11 Anchor">
                About Us
              </a>
            </div>
          </div>
          <div className="home-right-side">
            <button className="home-cta-btn1 button Anchor">Contact Us</button>
          </div>
          <div data-role="MobileMenu" className="home-mobile-menu">
            ...
            <div className="home-links-container2">
              <a href="#resources" className="home-link12 Anchor">
                Resources
              </a>
              <a href="#inspiration" className="home-link13 Anchor">
                Inspiration
              </a>
              <a href="#process" className="home-link14 Anchor">
                Process
              </a>
              <a href="#ourstory" className="home-link15 Anchor">
                Our story
              </a>
            </div>
          </div>
      ...
      <div id="resources" className="home-hero">
        <div className="home-content-container1">
          <div className="home-hero-text">
            ...
            <button className="home-cta-btn2 button Anchor">Contact Us</button>
          </div>
        </div>
      </div>
